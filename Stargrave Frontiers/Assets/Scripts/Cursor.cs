...
//This is the cursor script that attaches the game cursor to the grid. This works by getting the position of the pc cursor and finding the closest grid tile to it.
