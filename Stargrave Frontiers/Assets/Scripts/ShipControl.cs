...
public class ShipControl : Ship
{
    ...
    {
        if (actionPoints > weapon.actionCost)
        {
            actionPoints -= weapon.actionCost;//subtracts the cost for firing the weapon

            float accNum = (10 - weapon.accuracy) / 2;
            ...
            newObject.GetComponent<ShotScript>().distance = weapon.shotRange;//Sets the properties of the shot, according to the ship firing
